...
-- $Revision: 403 $
-- $Date: 2010-10-07 20:40:38 +1100 (Thu, 07 Oct 2010) $
...
function ArkInventoryRules.System.outfit_outfitter( ... )
	...
	if not ArkInventoryRules.Object.h or not IsAddOnLoaded( "Outfitter" ) or not Outfitter_IsInitialized( ) then
		return false
	end
	
	local ItemInfo = Outfitter_GetItemInfoFromLink( ArkInventoryRules.Object.h )
